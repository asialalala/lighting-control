...
import {
  ...
  ɵɵqueryRefresh,
  ɵɵviewQuery
} from "./chunk-IKG2GNMH.js";
import {
  require_cjs
} from "./chunk-AKHKBGXQ.js";
import {
  __async,
  __toESM
...
var ChartComponent = class _ChartComponent {
  ...
  ngOnChanges(changes) {
    ...
    this.ngZone.runOutsideAngular(() => {
      import_rxjs.asapScheduler.schedule(() => this.hydrate(changes));
    });
  }
  ngOnDestroy() {
    this.destroy();
  ...
  createElement() {
    return __async(this, null, function* () {
      const {
        default: ApexCharts
      } = yield import("./apexcharts.common-YFC4DHAC.js");
